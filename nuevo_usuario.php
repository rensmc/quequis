...
<br>
<p align="center">Llene el siguiente formulario para poder ser miembro en Pasteles y Quequis</p>
<br>
...
<table width="100%" border="1">
  ...
  <tr>
    ...
    <td align="left">
    <select name="pais">
    <option name="pais" value="Mexico">M&eacute;xico</option>
    <option name="pais" value="Estados Unidos">Estados Unidos</option>
    <option name="pais" value="Otro">Otro</option>
    </select></td>
  </tr>
  <tr>
